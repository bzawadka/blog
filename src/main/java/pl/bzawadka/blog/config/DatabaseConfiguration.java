package pl.bzawadka.blog.config;

import pl.bzawadka.blog.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("pl.bzawadka.blog.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("pl.bzawadka.blog.repository.search")
